  ...
  if (document.querySelector('.cart-footer') === null) {
    cartDOM.insertAdjacentHTML(
      ...
      <div class="cart-footer">
        <button class="btn btn--danger" data-action="CLEAR_CART">Limpiar Carro</button>
        <button class="btn btn--primary" data-action="CHECKOUT">Pagar</button>
      </div>
    `
    );
...
function countCartTotal() {
  ...
  document.querySelector('[data-action="CHECKOUT"]').innerText = `Pagar $${cartTotal}`;
}
